...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'account-manager'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Sources', path: '/sources', entity: 'source', service: AccessServiceEnum.PROJECT, icon: FiLink },
    {
      name: 'Source Invoices',
      path: '/source-invoices',
