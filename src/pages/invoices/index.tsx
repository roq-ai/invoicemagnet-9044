...
export function InvoiceListPage(props: InvoiceListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getInvoices({
        relations: ['company', 'user', 'invoice_item.count', 'source_invoice.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('invoice_item', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'invoice_item',
          header: 'Invoice Item',
          accessorKey: 'invoice_item',
          cell: ({ row: { original: record } }: any) => record?._count?.invoice_item,
        }
      : null,
    hasAccess('source_invoice', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'source_invoice',
          header: 'Source Invoice',
          accessorKey: 'source_invoice',
          cell: ({ row: { original: record } }: any) => record?._count?.source_invoice,
        }
      : null,
