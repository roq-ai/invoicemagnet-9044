...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`InvoiceMagnet`}</title>

        <meta
          name="description"
          content="InvoiceMagnet: Streamlining Your Business with Ease, Import Invoices from Various Sources in One Click. Simplify. Amplify. Unify."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxpbnZvaWNlc3xlbnwwfHx8fDE2OTU0Nzg3MzV8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`InvoiceMagnet: Streamlining Your Business with Ease, Import Invoices from Various Sources in One Click. Simplify. Amplify. Unify.`}
            </Text>
            <Box
